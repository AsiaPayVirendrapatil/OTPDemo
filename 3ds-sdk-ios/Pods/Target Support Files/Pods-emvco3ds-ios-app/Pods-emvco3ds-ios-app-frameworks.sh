...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${PODS_ROOT}/../emvco3ds-ios-pods/sdk_pod/swift42/x86/MI_SDK_EMVCO_UL.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/MaterialComponents/MaterialComponents.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/ObjectMapper/ObjectMapper.framework"
  install_framework "${PODS_ROOT}/../emvco3ds-ios-pods/protocols_pod/swift42/emvco3ds_protocols_ios.framework"
fi
...
if [[ "$CONFIGURATION" == "KEEPFETCHING" ]]; then
  install_framework "${BUILT_PRODUCTS_DIR}/Alamofire/Alamofire.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/AlamofireObjectMapper/AlamofireObjectMapper.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/CryptoSwift/CryptoSwift.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/MDFInternationalization/MDFInternationalization.framework"
