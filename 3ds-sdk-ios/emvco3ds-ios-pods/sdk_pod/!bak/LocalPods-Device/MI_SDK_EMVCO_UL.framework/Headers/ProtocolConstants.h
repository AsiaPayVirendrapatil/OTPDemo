...
static NSString * const KThreeDSRequestorAppURL = @"threeDSRequestorAppURL";
...
static NSString * const KThreeDSRequestorDecMaxTime = @"threeDSRequestorDecMaxTime";
static NSString * const KThreeDSRequestorDecReqInd = @"threeDSRequestorDecReqInd";
...
static NSString * const KACSChallengeMandatedIndicator = @"acsChallengeMandated";
static NSString * const KACSCounterAtoS = @"acsCounterAtoS";
static NSString * const KACSDecoupledConfirmationIndicator = @"acsDecConInd";
...
static NSString * const KBrowserJavascriptEnabled = @"browserJavascriptEnabled";
...
static NSString * const KChallengeNoEntry = @"challengeNoEntry";
...
static NSString * const KPayTokenSource = @"payTokenSource";
...
static NSString * const KWhitelistingDataEntry = @"whitelistingDataEntry";
static NSString * const KWhitelistingInfoText = @"whitelistingInfoText";
static NSString * const KWhiteListStatus = @"whiteListStatus";
static NSString * const KWhiteListStatusSource = @"whiteListStatusSource";
...
//"02" = Reserved for future EMVCo use
static NSString * const KTRANSACTION_TIMEDOUT_AT_DECOUPLED_AUTHENTICATION = @"03";
...
//The following are parameters used internally by the SDK
...
//Note: starting 2.1.0, OOB Creq will be auto-submitted during activity refresh
static NSString * const KChallengeOOBAutoCReq = @"challengeOOBAutoCReq";
