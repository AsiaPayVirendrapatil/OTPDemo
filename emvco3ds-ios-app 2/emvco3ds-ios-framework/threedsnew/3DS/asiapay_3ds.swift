...
public class asiapay_3ds: NSObject {
    
    @objc public static var isRegressionTest : Bool = false
    
    @objc public static var manager = asiapay_3ds1()
    ...
    //@objc public static let root  = PaymentView(nibName:"PaymentView",bundle:Emvco3dsFramework.bundle)
